...
class HSBody extends StatefulWidget {

  Function callback;
  List<dynamic> listLocal;
  HSBody({Key? key, required this.callback, required  this.listLocal}) : super(key: key);

  @override
  State<HSBody> createState() => _HSBodyState();
}

class _HSBodyState extends State<HSBody> {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      padding: EdgeInsets.only(top: Dimensions.h15, left: Dimensions.w05, right: Dimensions.w05),
      child: Column(
        children: [
